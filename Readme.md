...
# Configuration Script – mSafe - Rev. A

This **Configuration** script is designed for the **mSafe** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – mSafe Rev. A

Este script de **Configuration** está diseñado para el modelo **mSafe** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
